...
Description: 
This file is to show each admin feature.
Only the admin can see the admin tab on the navigation bar, and the admin 
manage the account, item, location, activity, review, and flight.
-->
